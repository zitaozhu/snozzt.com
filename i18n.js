...
const T = {
  en: {
    ...
    download_sub: 'Now available on the App Store. Beta and Android still open.',
    store_app_status: 'Available now',
    ...
    download_note: 'The App Store and TestFlight links above are live. Google Play will follow once Android review completes.',
  ...
  'zh-Hans': {
    ...
    download_sub: '现已在 App Store 上线。Beta 与 Android 仍在持续。',
    store_app_status: '现已上线',
    store_app_top: '在以下平台下载',
    store_tf_status: '公开测试',
    store_tf_top: '在以下平台加入测试',
    store_play_status: '规划中',
    store_play_top: '在以下平台获取',
    download_note: '上方的 App Store 与 TestFlight 链接现已开放。Google Play 将在 Android 审核通过后上线。',
  ...
  'zh-Hant': {
    ...
    download_sub: '現已在 App Store 上線。Beta 與 Android 仍在持續。',
    store_app_status: '現已上線',
    store_app_top: '於以下平台下載',
    store_tf_status: '公開測試',
    store_tf_top: '於以下平台加入測試',
    store_play_status: '規劃中',
    store_play_top: '於以下平台取得',
    download_note: '上方的 App Store 與 TestFlight 連結現已開放。Google Play 將在 Android 審核通過後上線。',
  ...
  ja: {
    ...
    download_sub: 'App Store で公開中。ベータと Android は引き続き受付中。',
    store_app_status: '公開中',
    store_app_top: '以下からダウンロード',
    store_tf_status: '公開ベータ',
    store_tf_top: 'ベータに参加',
    store_play_status: '計画中',
    store_play_top: '以下から入手',
    download_note: '上の App Store と TestFlight のリンクは現在公開中です。Google Play は Android の審査完了後に公開予定です。',
    support_title: '応援する',
  ...
  ko: {
    ...
    download_sub: 'App Store에서 출시되었습니다. 베타와 Android는 계속 진행 중입니다.',
    store_app_status: '출시됨',
    store_app_top: '다운로드',
    store_tf_status: '공개 베타',
    store_tf_top: '베타 참여',
    store_play_status: '계획 중',
    store_play_top: '받기',
    download_note: '위의 App Store와 TestFlight 링크는 현재 공개되어 있습니다. Google Play는 Android 심사가 완료되는 대로 공개됩니다.',
    support_title: '후원하기',
